...
@section('content')
    ...
    <div class="col-md-10 offset-md-1 dashboard-events-container">
        ...
        @else
            <p>Você ainda não tem eventos!
                <a href="/events/create">Crie um evento aqui</a>
            </p>
        @endif
    </div>
    <div class="col-md-10 offset-md-1 dashboard-title-container">
    ...
    <div class="col-md-10 offset-md-1 dashboard-events-container">
        ...
        @else
            <p>Você ainda não está participando de nenhum evento! <a href="/">Veja todos os eventos aqui</a></p>
        @endif
    </div>
